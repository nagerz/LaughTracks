...
eddie = Comedian.create(name: "Eddie Murphy", dob: "1961-04-03", city: "Brooklyn, NY", headshot: "images/dave_cover.jpg")
robin = Comedian.create(name: "Robin Williams", dob: "1951-07-21", city: "Chicago, Illinois", headshot: "images/dave_cover.jpg")
jerry = Comedian.create(name: "Jerry Seinfeld", dob: "1954-04-29", city: "Brooklyn, NY", headshot: "images/dave_cover.jpg")
bill = Comedian.create(name: "Bill Burr", dob: "1968-06-10", city: "Canton, Massachusettes", headshot: "images/dave_cover.jpg")
aziz = Comedian.create(name: "Aziz Ansari", dob: "1983-02-23", city: "Columbia, South Carolina", headshot: "images/dave_cover.jpg")
chelsea = Comedian.create(name: "Chelsea Handler", dob: "1975-02-25", city: "Livingston, New Jersey", headshot: "images/dave_cover.jpg")
jim = Comedian.create(name: "Jim Jeffries", dob: "1977-02-14", city: "Sydney, Australia", headshot: "images/dave_cover.jpg")
chris = Comedian.create(name: "Chris Rock", dob: "1965-02-07", city: "Andrews, South Carolina", headshot: "images/dave_cover.jpg")
demetri = Comedian.create(name: "Demetri Martin", dob: "1973-05-25", city: "New York City, NY", headshot: "images/dave_cover.jpg")
ellen = Comedian.create(name: "Ellen DeGeneres", dob: "1958-01-26", city: "Metairie, Louisiana", headshot: "images/dave_cover.jpg")
sarah = Comedian.create(name: "Sarah Silverman", dob: "1970-12-01", city: "Bedford, New Hampshire", headshot: "images/dave_cover.jpg")
